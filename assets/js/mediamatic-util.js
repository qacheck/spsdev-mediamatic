"use strict";
var mediamaticWMC = {};
mediamaticWMC.spsdev_mediamatic_begin_loading = function(){
	jQuery('.spsdev_mediamatic_be_loader').addClass('loading');
}
mediamaticWMC.spsdev_mediamatic_finish_loading = function(){

    jQuery('.spsdev_mediamatic_be_loader.loading').removeClass('loading').addClass('finish');
    setTimeout(function(){ 
         jQuery('.spsdev_mediamatic_be_loader.finish').removeClass('finish');
    }, 400);
